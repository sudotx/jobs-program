...
pub struct CreateTokenJobParams {
    pub amount: u64,
    pub expiry_slot: u64,
}

#[derive(Accounts)]
pub struct CreateTokenJob<'info> {
    #[account(mut)]
...
pub fn handler(ctx: Context<CreateTokenJob>, params: CreateTokenJobParams) -> Result<()> {
    ...
    job_account.total_amount = params.amount;
    ...
    job_account.milestone_amounts = Vec::new();
